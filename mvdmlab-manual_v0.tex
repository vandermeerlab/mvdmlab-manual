...
\hyperref[ch:animal-management]{Animal Recordkeeping} chapter, and (2)
lab notebooks/notes, described in the \hyperref[sec:notes]{Keeping
  Good Notes} section.
...
animals\sidenote{Some good examples are highlighted in the ``Position
  ...
  (\href{https://www.mpg.de/10882259/MPG_Whitepaper.pdf}{link})}. However, past
...
{\it Animal Use Protocols} (AUPs) \sidenote{{\it Animal Use Protocol}:
  ...
  (e.g.\ for changing cages or weighing) counts as a procedure!} that
...
\url{#animalcareandrecords} channel.
