...
animals\sidenote{Some good examples are highlighted in the ``Position
  ...
  \url{https://www.mpg.de/10882259/MPG_Whitepaper.pdf}}. However, past
successes do not mean we can experiment freely on any animal we
...
\item{We strive to {\it design experiments such that the outcomes will be
  ...
  by the NIH\sidenote{NIH reference}. Many experimental design
  decisions can be brought into focus by perparing a formal
  preregistration of your proposed
  experiment\sidenote{Preregistration}, which requires justifying how
...
{\it protocols}\sidenote{{\it Protocol}: document outlining the
  ...
  including specific animal numbers for each. The total number of
  approved animals may not be exceeded.}. Only {\it
  ...
  weighing) counts as a procedure} that have been approved by the
IACUC may be performed on animals, and only by approved personnel
(listed on the protocol). We are required to log all
procedures. Invasive procedures, such as electrode implant surgery,
require follow-up procedures providing post-operative
care (administration of analgesia, monitoring).
...
\item{Behave respectfully and professionally towards others in the
  ...
  how your actions (or lack of them) affect others\sidenote{Recurse
    guidelines}. We value behaviors that enable everyone to
...
\item{Keep at it. While brilliant ideas, creativity and skill
  ...
  you put in the work.}
\item{If you have an issue with a member of the lab, tell MvdM. If you
  ...
  are available.}
\item{Pictures/videos. Before taking pictures with a lab member in
  them, ask their consent first. Ask consent again before posting to
  social media. If you'd like to take pictures of an experimental
  subject, ask MvdM.}
\end{itemize}
...
\item{Provide an environment where great science can be done and
  people can thrive.}
\item{Give my perspective on where the field is going, and how work in
...
\item{Be a mentor, supporter, and resource for you. This includes
  ...
  opportunities.}
\item{Hold weekly lab meetings and project one-on-ones with you.}
\item{Give you timely feedback on project ideas, conference posters,
...
broad area, and deep in your chosen area\sidenote{See ``How to read a
  book'' book and MvdM's slides for some pointers on different kinds
  of reading.}.}
...
MBL\sidenote{\url{www.mbl.edu/nsb}}.}
\item{Be aware of what is required to take the next step of career paths you
are considering\sidenote{Some starting points for thinking about
  industry vs.\ academia include: }. If you are thinking about
...
distinction between {\it private resources} and {\it confidential
  resources}\sidenote{Private resources are legally obligated to share
  a disclosure of sexual misconduct with the Title IX office,
  including all details that are known. This is to ensure adequate
  support for those who may need it. Confidential resources may not
  share any information (with very few exceptions).}.
